...
const correctAnswers = {
    q1: '4',  // อุณหภูมิที่เหมาะสมสำหรับเนื้อผ้า
    q2: '1',  // สีของผ้า
    q3: '3',  // ภาษาธรรมชาติ
    q4: '2',  // ตามลำดับอัลกอริทึม
    q5: '2',  // START, STOP, BEGIN
    q6: '4',  // COMPUTE sum = number 1 + number 2
    q7: '2',  // ผังงาน (Flowchart)
    q8: '1',  // สัญลักษณ์เริ่มต้นและสิ้นสุด
    q9: '4',  // การออกแบบโปรแกรม
    q10: '4'  // เลือกกระทำ/เงื่อนไข (Selection/Condition)
};
